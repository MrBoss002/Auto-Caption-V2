    ...
    <div className="dashboard-shell">
      <aside className="sidebar">
        <div className="sidebar-brand">
          ...
          <div>
            <strong>MrBoss Auto-Caption</strong>
        ...
        <nav>
          ...
          <a className="nav-item">
            <Radio size={17} /> Channels
          </a>
          <a className="nav-item">
            <MessageSquare size={17} /> Activity
          </a>
        </nav>
        ...
        <div className="sidebar-bottom">
          <div className="side-status">
            ...
            <div>
              <strong>{stats?.dbConnected ? "MongoDB connected" : "MongoDB offline"}</strong>
              <span>
                {stats?.updatedAt
        ...
        <header className="topbar">
          ...
          <div className="topbar-actions">
            ...
            <div className="admin-pill">
              <ShieldCheck size={16} /> Public dashboard
            </div>
          </div>
        </header>
...
function Metric({
  ...
  return (
    <div className="metric-row">
      ...
      <strong>{raw ? value : number(value as number)}</strong>
    </div>
  );
}
